...
class Crud
{
    ...
    {
        foreach ($arr as $k => $v) {
            if (! class_exists($v) or ! is_subclass_of($v, \Modules\Admin\BaseCrudModule::class)) {
    ...
    {
        foreach ($arr as $k => $v) {
            if (! class_exists($v) or ! is_subclass_of($v, \Modules\Admin\Crud\Components\BaseComponent::class)) {
