...
@section('content')
    ...
    <div class="container-fluid" style="padding: 24px;">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{ __('Send Email') }}</h1>
        </div>

        @include('admin.message')

        <form action="{{ route('core.admin.send-email.store') }}" method="POST">
            @csrf
            ...
            <div class="notification-form-container" style="display: flex; gap: 30px;">
                ...
                <div class="bg-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" class="form-control" placeholder="{{ __('Email message') }}" required></textarea>
                        @error('message')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
    ...
    <script>
        console.log('Email Send Script - Initialized');
        ...
        function searchUsers(query) {
            ...
            fetch("{{ route('core.admin.send-email.getForSelect2') }}?q=" + encodeURIComponent(query))
        ...
        console.log('✓ Email Send Script - Ready');
    </script>
@endsection
