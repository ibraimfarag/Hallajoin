...
@section('content')
    ...
    <div class="container-fluid" style="padding: 24px;">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{ __('Notification') }}</h1>
        </div>

        @include('admin.message')

        <form action="{{ route('core.admin.send-notification.store') }}" method="POST">
            @csrf
            ...
            <div class="notification-form-container" style="display: flex; gap: 30px;">
                ...
                <div class="bg-form">
                    <div class="form-group">
                        {{-- <label for="tag_input">{{ __('User id') }}</label> --}}
    ...
    <script>
        console.log('User ID Field Script - Initialized');
        ...
        function searchUsers(query) {
            ...
            fetch("{{ route('core.admin.send-notification.getForSelect2') }}?q=" + encodeURIComponent(query))
        ...
        console.log('✓ User ID Field Script - Ready');
    </script>
@endsection
