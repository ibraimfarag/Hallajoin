...
@section('content')
                                    ...
                                    <select name="cate_id" class="form-control">
                                        ...
                                        @foreach ($tour_categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (Request()->cate_id == $category->id) selected @endif>{{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="100px"> {{ __('Share Whatsapp') }}</th>
                                <th width="100px"> {{ __('Share Mail') }}</th>
                                <th width="100px"></th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($rows->total() > 0)
                                @foreach ($rows as $row)
                                    <tr class="{{ $row->status }}">
                                        ...
                                        <div class="modal fade" id="whatsappModal{{ $row->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="whatsappModalLabel{{ $row->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="whatsappModalLabel{{ $row->id }}">
                                                            Enter Mobile Number for {{ $row->title }}</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="whatsappForm{{ $row->id }}">
                                                            <div class="form-group">
                                                                <label for="mobileNumber{{ $row->id }}">Mobile
                                                                    Number:</label>
                                                                <div class="select-box">
                                                                    <div class="selected-option">
                                                                        <div>
                                                                            <span class="iconify"
                                                                                data-icon="flag:gb-4x3"></span>
                                                                            <strong>+44</strong>
                                                                        </div>
                                                                        <input type="tel"     id="mobileNumber{{ $row->id }}" name="tel"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            onclick="sendWhatsAppMessage('{{ $row->id }}', 'hello')">Send
                                                            Message</button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td class="title">
                                            <a
                                                href="{{ route('tour.admin.edit', ['id' => $row->id]) }}">{{ $row->title }}</a>
                                        ...
                                        <td>
                                        <td>
                                            <img src="{{ asset('themes/admin/images/share/whatsaap.png') }}"
                                                alt="Share WhatsApp" style="width: 30px; cursor: pointer;"
                                                data-toggle="modal" data-target="#whatsappModal{{ $row->id }}">
                                        </td>
                                        </td>
                                        <td>
                                            <img src="{{ asset('themes/admin/images/share/mail.png') }}" alt="Share Mail"
                                                style="width: 30px; cursor: pointer;" data-toggle="modal"
    ...
    <div class="modal fade" id="mailModal" tabindex="-1" role="dialog" aria-labelledby="mailModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mailModalLabel">Enter Email Address</h5>
    ...
    <script>
        function sendWhatsAppMessage(rowId, message) {
            var mobileNumber = document.getElementById("mobileNumber" + rowId).value;
            if (mobileNumber != "") {
                // Construct the WhatsApp message URL
                var formattedMessage = encodeURIComponent(message);
                var whatsappUrl = "https://wa.me/" + mobileNumber + "/?text=" + formattedMessage;
                window.open(whatsappUrl, '_blank'); // Open in a new tab
                $('#whatsappModal' + rowId).modal('hide'); // Hide the modal
            } else {
        ...
        function sendEmail() {
            ...
            if (emailAddress != "") {
                ...
                var emailUrl = "mailto:" + emailAddress + "?subject=Hello&body=Hello,%0D%0A%0D%0ABest Regards";
