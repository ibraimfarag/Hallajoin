...
class Bookable extends BaseModel
{
    ...
    public $booking_detail_modal_file = '';
    ...
    public function addToCart(Request $request)
    {
        ...
        if ($existingItem) {
            ...
            $existingItem->booking_data = array_merge(
                $existingItem->booking_data ?: [],
                $cartData['booking_data']
            );
            $existingItem->updateTotalPrice();

            $message = __('Item quantity updated in cart successfully!');
        } else {
            ...
            \App\Models\CartItem::create([
                ...
                'total_price' => round($cartData['quantity'] * $cartData['price'], 2),
                'booking_data' => $cartData['booking_data'],
            ]);
    ...
    /**
     * Prepare cart data for the service
     * This method should be overridden by child classes
     */
    protected function prepareCartData(Request $request): array
    {
        $base_price = ($this->sale_price && $this->sale_price > 0 && $this->sale_price < $this->price)
            ? $this->sale_price
            : $this->price;
    ...
    public function getCurrencySvgAttribute()
    {
        return get_current_currency_svg();
    }
}
