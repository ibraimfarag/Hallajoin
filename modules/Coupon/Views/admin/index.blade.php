                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-2 mb-2">
                        <select name="discount_type" class="form-control">
                            ...
                            <option value="percent" {{ request('discount_type') == 'percent' ? 'selected' : '' }}>Percent
                            </option>
                            <option value="fixed" {{ request('discount_type') == 'fixed' ? 'selected' : '' }}>Fixed
                            </option>
                        </select>
                    </div>
                    <div class="col-md-2 mb-2">
                    ...
                    <div class="d-flex " style="gap:50px;margin: 20px;">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="extra_discount" id="extra_discount"
                                value="1" {{ request('extra_discount') ? 'checked' : '' }}>
                                                    ...
                                                    <div style="display: flex; align-items: center; gap: 8px;">
                                                        ...
                                                        <form
                                                            ...
                                                            <button type="submit" class="btn "
                                                                title="{{ __('Delete') }}"><i class="fa fa-times"
