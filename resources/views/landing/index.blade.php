...
<body>
                    ...
                    <div class="col-xs-9">
                        <div class="dropdown dropdown-main-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="https://www.facebook.com/bookingcore/"
                                    target="_blank">Support</a>
                                <a target="_blank" class="dropdown-item"
                                    href="http://docs.bookingcore.org">Documentation</a>
                                <a target="_blank" href="{{ config('landing.item_url') }}"
                                    class="dropdown-item btn-buynow">BUY NOW</a></li>
                            </div>
                        </div>
                        <ul class="menu">
                            <li>
                                <a target="_blank" href="{{ config('landing.item_url') }}" class="btn-buynow">BUY
                                    NOW</a>
                            </li>
    ...
    <div class="footer">
        ...
        <div class="container">
            ...
            <div class="social">
                <span>FOLLOW US</span>
                <ul>
                    <li><a target="_blank" href="https://www.facebook.com/bookingcore/"><svg width="10"
                                height="19" viewBox="0 0 10 19" fill="none"
                    ...
                    <li><a target="_blank" href="#"><svg width="20" height="14" viewBox="0 0 20 14"
                    ...
                    <li><a href="mailto:bookingcore.org@gmail.com"><svg width="18" height="14"
    ...
    <script src="{{ url('themes/bc/js/owl.carousel.min.js') }}"></script>
