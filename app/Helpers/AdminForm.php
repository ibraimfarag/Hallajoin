...
class AdminForm
{
    ...
    {
        ?>
        <select class="form-control <?php echo e($class) ?>" <?php if ($forListItem) {
            echo '__name__';
        } else {
            echo 'name';
        } ?>="<?php echo e($name) ?>">
    ...
    {
        ?>
        <select <?php if ($multiple) {
            echo 'multiple';
        } ?> id="select_<?php echo e($name)?>" <?php if (isset($options['required'])) {
            echo 'required';
        } ?> class="form-control <?php echo e($attrs['class'] ?? 'dungdt-select2-field') ?>" data-options='<?php echo e(json_encode($options['configs'])) ?>' name="<?php echo e($name) ?>">
            <?php if ($multiple) { ?>
        ...
        if (! empty($options)) {
            ...
            foreach ($options as $option) {
                switch ($option['type']) {
                    case 'checkbox':
                        ?>
                        <div class="form-group" <?php if (! empty($option['condition'])) {
                            echo 'data-condition="'.e($option['condition']).'"';
                        } ?> >
                            <label class="" >
                                <input type="checkbox" class="form-control" name="<?php echo e($option['id']) ?>" value="1" <?php if ($option['value'] == 1) {
                                    echo 'checked';
                                } ?>>
                                ...
                                <select name="<?php echo e($option['id']) ?>" class="form-control">
                                    ...
                                    <?php if (! empty($option['options'])) {
                                        foreach ($option['options'] as $val => $label) {
                                            ?>
                                            <option <?php if ($option['value'] == $val) {
                                                echo 'selected';
