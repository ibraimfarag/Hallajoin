...
class Assets
{
    ...
    public static function registerJs($file, $inFooter = true, $pos = 10, $version = false, $in_line = false)
    {
        if (empty($file)) {
            return;
        }
    ...
    public static function registerCss($file, $inFooter = false, $pos = 10, $version = false)
    {
        if (empty($file)) {
            return;
        }
    ...
    public static function js($inFooter = false)
    {
        $res = [];
        $html = '';
    ...
    public static function css($inFooter = false)
    {
        $res = [];
        $html = '';
    ...
    public static function __handleUrl($item)
    {
