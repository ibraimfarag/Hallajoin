        ...
        watch: {
            ...
            selected: {
                handler: function (newVal) {
                    // Update selectAll based on whether all files are selected
                    this.selectAll = newVal.length > 0 && newVal.length === this.files.length;
                },
                deep: true
            },
            files: function () {
                // Reset selectAll when files change
