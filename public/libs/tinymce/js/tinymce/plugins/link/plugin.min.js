...
!(function (c) {
    ...
    var n,
        ...
        v = function (n) {
            var t = n.link_assume_external_targets;
            return "boolean" == typeof t && t
                ? 1
                : "string" != typeof t || ("http" !== t && "https" !== t)
                ? 0
                : t;
        },
        s = function (n) {
            return (
                "boolean" == typeof n.link_context_toolbar &&
                n.link_context_toolbar
            );
        },
        g = function (n) {
            return n.link_list;
            ...
            var e,
                ...
                u = function (n) {
                    return n.filter(function (n) {
                        return -1 === G.inArray(o, n);
                    });
                },
                a = t ? (0 < (e = u((e = i))).length ? e.concat(o) : o) : u(i);
            return 0 < a.length ? ((r = a), G.trim(r.sort().join(" "))) : "";
        },
        Q = function (n, t) {
            return (
        ...
        Z = function (n) {
            return (
                n && "FIGURE" === n.nodeName && /\bimage\b/i.test(n.className)
            );
        },
        nn = function (n) {
            return (
        ...
        rn = function (d, h, p) {
            d.undoManager.transact(function () {
                var n,
                    ...
                    c,
                    l,
                    f = d.selection.getNode(),
                    s = Q(d, f),
                    g = nn(p);
                if (!x(d.settings) && !1 === w(d.settings)) {
                    var m = X(g.rel, "_blank" === g.target);
                    g.rel = m || null;
                }
                (g.href =
                    ((n = g.href),
                    ("http" !== (t = v(d.settings)) && "https" !== t) || J(n)
                        ? n
                        : t + "://" + n)),
                    p.href === h.href && h.attach(),
                    s
                        ? (d.focus(),
                          (u = d),
                          (a = s),
                          ...
                          (l = g),
                          c.each(function (n) {
                              a.hasOwnProperty("innerText")
                                  ? (a.innerText = n)
                                  : (a.textContent = n);
                          }),
                          u.dom.setAttribs(a, l),
                          u.selection.select(a))
                        : ((e = d),
                          (r = f),
                          (o = p.text),
                          (i = g),
        ...
        Cn = tinymce.util.Tools.resolve("tinymce.util.Delay"),
        _n = function (n) {
            var t = n.href;
            return 0 < t.indexOf("@") &&
                -1 === t.indexOf("//") &&
        ...
        Tn = function (u, n, a) {
            return mn(
                ...
                function (i) {
                    return An.nu(function (t) {
                        var e, n, r, o;
                        (e = u),
                            (n = i.message),
                            (r = function (n) {
                                c.console.log("state", n),
                                    t(n ? i.preprocess(a) : a);
                            }),
                            (o = e.selection.getRng()),
                            Cn.setEditorTimeout(e, function () {
        ...
        Dn = tinymce.util.Tools.resolve("tinymce.util.XHR"),
        Mn = function (t) {
            var e = function (n) {
        ...
        Un = function (n) {
            if (d(n.settings)) {
                var t = m(n.settings);
                return pn.sanitize(t).orThunk(function () {
                    return z.some(En);
                });
            }
            return z.none();
            ...
            return Mn(s).map(function (n) {
                var t,
                    ...
                    f =
                        ...
                        (r = (t = s).selection),
                        (o = t.dom),
                        (i = cn(r.getContent()) ? z.some(fn(r, e)) : z.none()),
                        (u = e ? z.some(o.getAttrib(e, "href")) : z.none()),
                        (a = e ? z.from(o.getAttrib(e, "target")) : z.none()),
                        (c = Pn(o, e, "rel")),
                        (l = Pn(o, e, "class")),
                        {
                            url: u,
                ...
                return {
                    ...
                    optNode: z.from(m),
                    flags: { titleEnabled: O(g) },
                };
            });
        },
        zn = function (p) {
            var n, t, e;
            ((t = (n = p).settings), (e = ln(n)), Rn(n, t, e))
                .map(function (n) {
                    var i,
                        u,
                        a,
                    ...
                    return (
                        ...
                        (g = {
                            ...
                            target: o.anchor.target.or(c).getOr(""),
                        ...
                        (d = t.catalogs),
                        {
                            ...
                            body: {
                                ...
                                items: H([
                                    ...
                                    (function (n) {
                                        ...
                                        d.anchor.map(
                                            pn.createUi("anchor", "Anchors")
                                        ),
                                        d.rels.map(pn.createUi("rel", "Rel")),
                                        d.targets.map(
                                            pn.createUi(
                                                "target",
                                                "Open link in..."
                                        ...
                                        d.link.map(
                                            pn.createUi("link", "Link list")
                                        ),
                                        d.classes.map(
                                            pn.createUi("linkClass", "Class")
                                        ),
                                    ]),
                                ]),
                            },
                            ...
                            onChange: function (t, n) {
                                var e = n.name;
                                m.onChange(t.getData, { name: e }).each(
                                    function (n) {
                                        t.setData(n);
                                    }
                                );
        ...
        Kn = function (n) {
            return qn(n, n.selection.getStart());
        },
        In = function (n, t) {
            if (t) {
                var e = an(t);
        ...
        Vn = function (r) {
            r.on("click", function (n) {
                var t = qn(r, n.target);
                t && u.metaKeyPressed(n) && (n.preventDefault(), In(r, t));
            }),
                ...
                commands: [
                    {
                        ...
                        onSetup: function (n) {
                            var t = i.selection.getNode();
                            return n.setActive(!!ln(i, t)), Fn(i)(n);
                        },
                        onAction: function (n) {
                            var t = ln(i),
                                e = n.getValue();
    ...
    !(function Yn() {
        i.add("link", function (n) {
            Gn(n), Jn(n), Xn(n), Qn(n), Vn(n), Hn(n), $n(n);
        });
    })();
})(window);
