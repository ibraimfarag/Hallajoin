...
!(function () {
    ...
    var a,
        ...
        N = tinymce.util.Tools.resolve("tinymce.html.SaxParser"),
        ...
        H = {
            getMaxWidth: R("maxWidth"),
            getMaxHeight: R("maxHeight"),
            setMaxWidth: W("maxWidth"),
            setMaxHeight: W("maxHeight"),
        },
        L = E.DOM,
        I = function (e) {
            return L.getAttrib(e, "data-ephox-embed-iri");
        },
        q = function (e, t) {
            return (
                (c = t),
                (u = L.createFragment(c)),
                "" !== I(u.firstChild)
                    ? ((o = t),
                      (a = L.createFragment(o).firstChild),
                      {
                          type: "ephox-embed-iri",
                          source1: I(a),
                          source2: "",
                          poster: "",
                          width: H.getMaxWidth(a),
                          height: H.getMaxHeight(a),
                      })
                    : ((n = e),
                      (r = t),
                      N({
        ...
        J = tinymce.util.Tools.resolve("tinymce.html.Writer"),
        ...
        X = function (e, t) {
            var r,
                n,
                i = Q.createFragment(e).firstChild;
            return (
                H.setMaxWidth(i, t.width),
                H.setMaxHeight(i, t.height),
                (r = i.outerHTML),
                (n = J()),
                N(n).parse(r),
                n.getContent()
        ...
        Y = function (e, t, r) {
            return (
                (s = e),
                (l = Q.createFragment(s)),
                "" !== Q.getAttrib(l.firstChild, "data-ephox-embed-iri")
                    ? X(e, t)
                    : ((n = e),
                      (i = t),
                      (o = r),
        ...
        ee = function (r, e) {
            var n = C.extend({}, e);
            if (!n.source1 && (C.extend(n, q(M(r), n.embed)), !n.source1))
                return "";
            n.source2 || (n.source2 = ""),
                n.poster || (n.poster = ""),
                (n.source1 = r.convertURL(n.source1, "source")),
                (n.source2 = r.convertURL(n.source2, "source")),
                (n.source1mime = G(n.source1)),
                (n.source2mime = G(n.source2)),
            ...
            if (
                ...
                return Y(n.embed, n, !0);
            var a = U(M(r), n.source1);
            a &&
                ((n.type = "script"),
                (n.width = a.width),
                (n.height = a.height));
        ...
        le = function (a) {
            var e,
                ...
                o =
                    ...
                    (r = t.getAttribute("data-ephox-embed-iri"))
                        ? {
                              source1: r,
                              width: H.getMaxWidth(t),
                              height: H.getMaxHeight(t),
                          }
                        : t.getAttribute("data-mce-object")
                        ? q(M(e), e.serializer.serialize(t, { selection: !0 }))
                        : {}),
                c = {
                    source1: "",
                    source2: "",
            ...
            var f = { title: "Advanced", name: "advanced", items: h },
                p = [m, d];
            0 < h.length && p.push(f);
                ...
                w = a.windowManager.open({
                    ...
                    onSubmit: function (e) {
                        var t,
                            ...
                            n = s(e);
                        (r = a),
                            ((t = n).embed = Y(t.embed, t)),
                            t.embed && ie(t.source1)
                                ? se(r, t.embed)
                                : ne(r, t)
                                      .then(function (e) {
                                          se(r, e.html);
        ...
        he = tinymce.util.Tools.resolve("tinymce.html.Node"),
        ...
        we = function (e, t) {
            ...
            return (
                ...
                (i = new he("span", 1)).attr("class", "mce-shim"),
                r.append(n),
                r.append(i),
                r
            );
        ...
        ve = function (e, t, r) {
            ...
            (c = t.firstChild && t.firstChild.value) &&
                (r.attr("data-mce-html", escape(pe(e, c))),
                (r.firstChild = null));
        },
        be = function (e) {
            for (; (e = e.parent); )
                    ...
                    (t = e[n]).parent &&
                        (t.parent.attr("data-mce-object") ||
                            (("script" !== t.name ||
                                ...
                                "iframe" === t.name && S(i) && fe.ceFalse
                                    ? be(t) || t.replace(we(i, t))
                                    : be(t) || t.replace(ge(i, t)))));
            };
        },
        xe = function (d) {
            d.on("preInit", function () {
                var t = d.schema.getSpecialElements();
                C.each("video audio iframe object".split(" "), function (e) {
                    t[e] = new RegExp("</" + e + "[^>]*>", "gi");
                });
                ...
                C.each(
                    ...
                    d.serializer.addAttributeFilter(
                        ...
                        function (e, t) {
                            for (
                                var r, n, i, o, a, c, u, s, l = e.length;
                                l--;
            ...
            t.on("click keyup", function () {
                ...
                t.on("ObjectResized", function (e) {
                    ...
                    r.getAttribute("data-mce-object") &&
                        ...
                        r.setAttribute(
                            "data-mce-html",
                            escape(Y(t, { width: e.width, height: e.height }))
                        ));
                });
        },
        Ae = function (e) {
    ...
    !(function _e() {
        i.add("media", function (e) {
            return de(e), Ae(e), je(e), xe(e), Oe(e), me(e);
        });
    })();
})();
