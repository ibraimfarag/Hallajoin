                                ...
                                <div class="col-md-4 d-none">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc"><?php echo e(__("Updater HallaJoin")); ?></span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc"><?php echo e(__("Plugins for HallaJoin")); ?></span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc"><?php echo e(__("Clear Cache for HallaJoin")); ?></span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\MAMP\htdocs\core\modules/Core/Views/admin/tools/index.blade.php ENDPATH**/ ?>