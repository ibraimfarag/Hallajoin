...
<a href="mailto:contact@bookingcore.com">contact@bookingcore.com</a>',
    ...
    {
        $version = '2.0.9';
        if (version_compare(setting_item('update_to_200'), $version, '>=')) {
            return;
        }
    ...
    {
        $version = '2.1.0';
        if (version_compare(setting_item('update_to_210'), $version, '>=')) {
            return;
        }
    ...
    {
        $version = '2.2.0.1';
        if (version_compare(setting_item('update_to_220'), $version, '>=')) {
            return;
        }
    ...
    {
        $version = '2.3.0';
        if (version_compare(setting_item('update_to_230'), $version, '>=')) {
            return;
        }
    ...
    {
        $version = '1.0.6';
        if (version_compare(setting_item('update_to_240'), $version, '>=')) {
            return;
        }
