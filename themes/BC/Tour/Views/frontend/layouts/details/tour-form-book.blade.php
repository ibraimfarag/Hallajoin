...
<div class="bravo_single_book_wrap @if (setting_item('tour_enable_inbox')) has-vendor-box @endif">
    ...
    color: #000;"></i>
                        ...
                        <!-- Collapsible Content -->
                        <div class="collapse " id="personOptions">
                            <!-- Check if person types exist -->
                            <div id="personTypesContent">
                                <div class="form-group form-guest-search">
                                    <div class="guest-wrapper d-flex justify-content-between align-items-center">

                                        <div class="" v-if="person_types">
                                            <div class="form-group form-guest-search"
                                                v-for="(type,index) in person_types">
                                                <div
                            ...
                            <!-- Add more person types as needed -->
                        </div>
