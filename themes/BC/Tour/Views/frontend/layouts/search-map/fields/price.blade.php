<div class="filter-item filter-simple dropdown">
    <div class="form-group dropdown-toggle" id="priceFilterDropdown" data-toggle="dropdown">
        <h3 class="filter-title">{{__('Price filter')}} <i class="fa fa-angle-down"></i></h3>
    </div>
    <div class="filter-dropdown dropdown-menu dropdown-menu-right" aria-labelledby="priceFilterDropdown">
