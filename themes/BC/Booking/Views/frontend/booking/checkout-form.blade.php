...
{{-- 
                ...
                <div class="form-group">
                    <label>{{ __('Phone') }} <span class="required">*</span></label>
                    <div class="select-box-checkout">
                        <div class="selected-option-checkout">
                            <div>
                                <span class="iconify" data-icon="flag:gb-4x3"></span>
                            </div>
                            <input type="tel" id="phone" placeholder="{{ __('Your Phone') }}"
                                class="form-control" value="{{ $user->phone ?? '' }}" name="phone">
                        </div>
                        <div class="country-list">
                            <input type="text" class="country-search" placeholder="Search Country Name">
                            <ol>
                                <!-- Country options will be inserted here -->
                            </ol>
                        </div>
                    </div>
