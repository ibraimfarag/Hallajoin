...
class News extends Seeder
{
    ...
    public function run()
    {
        ...
        $list_categories = [
            ['name' => 'Adventure Travel', 'slug' => 'adventure-travel',  'status' => 'publish'], ['name' => 'Ecotourism', 'slug' => 'ecotourism',  'status' => 'publish'], ['name' => 'Sea Travel ', 'slug' => 'sea-travel',  'status' => 'publish'], ['name' => 'Hosted Tour', 'slug' => 'hosted-tour',  'status' => 'publish'], ['name' => 'City trips ', 'slug' => 'city-trips',  'status' => 'publish'], ['name' => 'Escorted Tour ', 'slug' => 'escorted-tour',  'status' => 'publish'],
        ];
